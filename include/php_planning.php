<?php   
$connexionbd = mysqli_connect("localhost", "root", "26182619Iz@", "grc");
...
$info_resa = mysqli_fetch_all($query_resa, MYSQLI_ASSOC);
        ...
        for($heure = 8; $heure <= 15; $heure++)//génération lignes des heures
            {                
                ?>  
                <tr>
                        ...
                        if(!empty($info_resa))
                            {                                                                                             
                                ...
                                if ($case == null)
                                    {                                                                                                                                                                                                           
                                        ?>
                                        <td class="case"><a href="reservation-form.php?heure_debut=<?php echo $heure;?>&amp;date_debut=<?php echo $jour;?>">Réserver une Salle</a></td>
                                        <?php
                                    }                                                                                                                                                
                            }                                                                                                       
                        else
